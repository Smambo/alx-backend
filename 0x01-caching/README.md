...
* `def get(self, key):`
  ...
  * If `key` is `None` or if the `key` doesn’t exist in `self.cache_data`, return `None`. <br>
```
simam@DESKTOP-5QTVNRV:~/alx-backend/0x01-caching$ cat 2-main.py
#!/usr/bin/python3
""" 2-main """
...
my_cache.print_cache()
simam@DESKTOP-5QTVNRV:~/alx-backend/0x01-caching$ ./2-main.py
Current cache:
A: Hello
B: World
C: Holberton
...
* `def get(self, key):`
  ...
  * If `key` is `None` or if the `key` doesn’t exist in `self.cache_data`, return `None`. <br>
```
simam@DESKTOP-5QTVNRV:~/alx-backend/0x01-caching$ cat 3-main.py
#!/usr/bin/python3
""" 3-main """
...
my_cache.put("K", "K")
my_cache.print_cache()
simam@DESKTOP-5QTVNRV:~/alx-backend/0x01-caching$ ./3-main.py
Current cache:
A: Hello
B: World
C: Holberton
...
* `def get(self, key):`
  ...
  * If `key` is `None` or if the `key` doesn’t exist in `self.cache_data`, return `None`. <br>
```
simam@DESKTOP-5QTVNRV:~/alx-backend/0x01-caching$ cat 4-main.py
#!/usr/bin/python3
""" 4-main """
...
my_cache.put("K", "K")
my_cache.print_cache()
simam@DESKTOP-5QTVNRV:~/alx-backend/0x01-caching$ ./4-main.py
Current cache:
A: Hello
B: World
C: Holberton
...
[5. LFU Caching](./100-lfu_cache.py)<br>
...
* `def get(self, key):`
  * Must return the value in `self.cache_data` linked to `key`.
  * If `key` is `None` or if the `key` doesn’t exist in `self.cache_data`, return `None`. <br><br>
```
simam@DESKTOP-5QTVNRV:~/alx-backend/0x01-caching$ cat 100-main.py
#!/usr/bin/python3
""" 100-main """
...
my_cache.put("M", "M")
my_cache.print_cache()
simam@DESKTOP-5QTVNRV:~/alx-backend/0x01-caching$ ./100-main.py
Current cache:
A: Hello
B: World
C: Holberton
